...
from unet_se_block.road_mark_dataset import RoadMarkDataset
from unet_se_block.unet_se_block import UnetSEBlock
...
def train_model():
    ...
    model = UnetSEBlock(n_channels=3, n_classes=1).to(MODEL_CONFIG["device"])
