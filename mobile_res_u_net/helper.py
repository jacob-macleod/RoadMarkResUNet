...
from mobile_res_u_net.model_config import MODEL_CONFIG
from mobile_res_u_net.road_mark_dataset import RoadMarkDataset
from mobile_res_u_net.mobile_res_unet import MobileResUNet
...
def train_model():
    ...
    model = MobileResUNet(n_channels=3, n_classes=1).to(MODEL_CONFIG["device"])
